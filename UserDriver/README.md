...
7. 前飞途中一旦收到有效 MaixCAM 目标，切换为视觉速度闭环，使无人机保持在图案上空。
8. 目标在中心容差内连续保持约 3.5 秒后进入一键降落，完成任务。
9. 视觉跟随期间若暂时丢失目标或偏出中心，中心计时清零；丢失时立即清零视觉速度和积分，并在当前位置悬停等待重新识别。
10. 若前飞到终点仍未发现目标，则将 IOA3/PB0 拉低释放物体，随后进入一键降落流程。
